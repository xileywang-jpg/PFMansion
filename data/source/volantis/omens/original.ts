...
export const OMENS_DATA = {
  "vol_omen_cursed_coin": {
    ...
    "onTurnStart": {
      "type": "CHECK",
      "condition": { "op": "EQ", "stat": "sanity", "value": 0 },
      "effect": { "type": "lose_game", "message": "理智归零，你被金币的诅咒吞噬！" }
    }
  },
  "vol_omen_oracle_skull": {
    ...
    "type": "OMEN",
    "passiveEffects": [
      { "type": "special", "text": "可预知下一个事件（需行动）" }
    ],
    "grantedActions": [
      {
        "id": "action_prophecy",
        ...
        "effects": [
          ...
          { "type": "LOG", "message": "头骨揭示了命运的轨迹...", "style": "narrative" }
        ]
      }
    ]
  },
  ...
  "vol_omen_shadow_mirror": {
    ...
    "grantedActions": [
      {
        "id": "action_mirror_copy",
        "name": "镜像复制",
        "description": "复制范围内一个单位的能力",
        "condition": { "op": "GT", "stat": "sanity", "value": 3 },
        "effects": [
          { "type": "special", "effect": "copy_ability", "target": "NEAREST_ENEMY" },
          { "type": "LOG", "message": "你复制了敌人的能力！", "style": "success" }
        ]
      }
    ]
  },
  "vol_omen_titan_eye": {
    ...
    "passiveEffects": [
      { "type": "buff", "text": "知识+2" },
      { "type": "special", "text": "自动识破伪装和隐匿" }
    ],
    "onEnterTile": {
      "type": "AUTO_REVEAL",
      "message": "泰坦之眼揭示了隐藏的区域！"
    }
  },
  ...
  "vol_omen_demon_flame": {
    ...
    "onAttack": {
      "type": "ADD_EFFECT",
      "effect": { "type": "burn", "damage": 1, "duration": 2 },
      "message": "恶魔之焰灼烧着敌人！"
    }
  },
    ...
    "grantedActions": [
      {
        ...
        "cooldown": 3,
        "effects": [
          { "type": "special", "effect": "reroll" },
          { "type": "LOG", "message": "你改写了命运！", "style": "success" }
        ]
      }
    ]
  },
  "vol_omen_void_crystal": {
    ...
    "grantedActions": [
      {
        "id": "action_void_teleport",
        "name": "虚空穿越",
        "description": "传送到任意已揭示区域",
        "cost": { "type": "sanity", "amount": 2 },
        "effects": [
  ...
  "vol_omen_siren_voice": {
    ...
    "type": "OMEN",
    "passiveEffects": [
      { "type": "special", "text": "敌人攻击你时有一定几率迷惑" }
    ],
    "onEnemyAttack": {
      "type": "CHECK",
      "condition": { "op": "ROLL_CHANCE", "value": 30 },
      "effect": { "type": "confuse", "target": { "type": "ATTACKER" }, "duration": 1 },
      "message": "塞壬之声迷惑了攻击者！"
    }
  },
  "vol_omen_medusa_gaze": {
    ...
    "onAttack": {
      "type": "CHECK",
      "condition": { "op": "ROLL_CHANCE", "value": 20 },
      "effect": { "type": "petrify", "target": { "type": "TARGET" }, "duration": 2 },
      "message": "敌人被石化了！"
    }
  }
};
