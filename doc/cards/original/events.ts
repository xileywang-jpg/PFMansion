...
export const EVENTS_DATA = {
  "event_burning_man": {
    ...
    "interaction": {
      ...
      "difficulty": 4,
      "success": [
        { "type": "modify_stat", "attribute": "knowledge", "amount": 1, "message": "你意识到这只是幻象并获得了洞察力。" },
        { "type": "narrative_log", "message": "火焰如同出现时一样迅速熄灭了。" }
      ],
      "failure": [
        { "type": "modify_stat", "attribute": "sanity", "amount": -1, "message": "剧烈的恐惧灼伤了你的精神。" },
  ...
  "event_creaky_floor": {
    ...
    "interaction": {
      ...
      "failure": [
        ...
        { "type": "modify_stat", "attribute": "might", "amount": -1, "message": "坠落造成了 1 点物理伤害。" },
  ...
  "event_ghost_whisper": {
    ...
    "interaction": {
        ...
        "difficulty": 4,
        "success": [
          { "type": "modify_stat", "attribute": "knowledge", "amount": 1, "message": "你稳住了心神，从低语中捕捉到了线索。" },
          { "type": "narrative_log", "message": "你成功抵抗了恐惧。" }
        ],
        "failure": [
          { "type": "modify_stat", "attribute": "sanity", "amount": -1, "message": "这声音像爪子一样撕扯着你的理智。" },
  ...
  "event_vines": {
    ...
    "interaction": {
        ...
        "failure": [
          { "type": "modify_stat", "attribute": "speed", "amount": -1, "message": "长刺刺伤了你的腿，行动受阻。" },
  ...
  "event_vault_chest": {
    ...
    "interaction": {
        ...
        "success": [
            ...
            { "type": "narrative_log", "message": "你用力撬开了锁，发现了里面的宝藏！" }
        ],
        "failure": [
            { "type": "narrative_log", "message": "锁纹丝不动。也许下次运气会好点。" }
        ]
    }
  },
  "event_coffin": {
    ...
    "type": "EVENT",
    "title": "漆黑的棺材",
    "description": "你发现了一个打开的棺材，里面躺着一具苍白的躯体。它看起来像是在沉睡，又或者在等待。",
    "icon": "Moon",
    "triggerType": "ON_ENTER",
    "interaction": {
      "type": "CHOICE",
