...
### 3.2 作祟检定回合 (HauntRoll Turn)

```
┌─────────────────────────────────────────────────────────────┐
│ 触发条件: OmenCount >= 6                                     │
├─────────────────────────────────────────────────────────────┤
│ 1. 设置 Phase = 'HAUNT_ROLL'                                │
│ 2. 后端自动投 6 个骰子                                       │
│ 3. 计算 sum                                                  │
│ 4. 比较 sum vs OmenCount                                     │
│                                                              │
│   sum >= OmenCount → Phase = 'EXPLORATION' (暂时安全)        │
│   sum < OmenCount  → Phase = 'HAUNT_REVEAL' (作祟爆发)       │
└─────────────────────────────────────────────────────────────┘
```
